...
window.Global.staff = [{
  ...
  name: 'Jessica Noesen, LPC',
  title: 'Therapist',
  image: './images/Jessica-Noesen.jpeg',
  descriptions: ['Jessica Noesen is a licensed professional counselor and has practiced group and individual therapy in Illinois, Indiana, and Colorado. Jessica received her BA in Psychology from California State University, Fullerton, where she began working as an addiction tech and became dedicated to the recovery of women. From there, she went on to obtain her MA in Counseling Psychology at The Chicago School of Professional Psychology, graduating with a focus in addiction treatment.', 'Jessica has worked in various levels of care with diverse clients in both substance use and mental health treatment facilities.She has training in CBT, DBT, ACT, Motivational Interviewing, and CPT to treat depression, anxiety, and trauma in women, teens, and adults.', 'Outside of The Rose House, Jessica continues to serve others in a private practice and spends her free time exploring colorful Colorado, hiking, and doing photography.']
}, {
  name: 'Kathy Pahler',
